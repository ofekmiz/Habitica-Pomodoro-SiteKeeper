...
function onPopupPageLoad() {
    ...
    if ($('#SiteTable tr').length == 0) {
        tbl.append(`<p id="welcomeInfo" data-testid="welcome-info">Navigate to the sites you want to block during Pomodoro and click on 'Block Site'.<br><br> If Habitica is connected, choose a cost for visiting the site (cost 0 is blocked only during Pomodoro).</p>`);
    }
